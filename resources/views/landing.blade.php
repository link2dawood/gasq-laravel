        ...
        <div class="container text-center px-4">
            ...
            <div class="d-flex flex-column flex-md-row gap-3 justify-content-center align-items-center mb-5">
                @auth
                    ...
                    <a href="{{ route('pricing') }}" class="btn btn-outline-primary btn-lg px-4 py-3">
    ...
    <section id="buyers" class="gasq-section">
        <div class="container px-4">
            ...
            @auth
                <div class="gasq-cta-box rounded-3 p-4 p-lg-5 mb-5">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            <a href="{{ route('pricing') }}" class="btn btn-outline-primary w-100 py-3">
                                <i class="fa fa-lightbulb me-2"></i>Know Before You Buy
                            </a>
            ...
            <div class="text-center">
                <a href="{{ route('pricing') }}" class="btn btn-primary btn-lg">Know Before You Buy →</a>
            </div>
        </div>
    </section>
            ...
            <div class="row g-4 justify-content-center">
                <div class="col-md-6">
                    <div class="gasq-card card p-4 p-lg-5 h-100">
                        ...
                        <a href="{{ route('pricing') }}" class="btn btn-primary w-100 py-3">Know Before You Buy →</a>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="gasq-card card p-4 p-lg-5 h-100">
