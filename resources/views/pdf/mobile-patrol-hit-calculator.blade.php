...
<table width="100%" cellpadding="0" cellspacing="0" style="background:#ffffff; border-bottom:3px solid #1e3558;">
  <tr>
    ...
    <td style="padding:14px 12px; vertical-align:middle;">
      <p style="font-size:18px; font-weight:bold; color:#1e3558; letter-spacing:0.01em; margin-bottom:4px;">GASQ Mobile Patrol Hit Service Report</p>
      <p style="font-size:8.5px; color:#6b7280; text-transform:uppercase; letter-spacing:0.12em;">Per-Check Pricing &amp; Revenue Analysis</p>
    </td>
