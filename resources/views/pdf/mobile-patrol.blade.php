...
<table width="100%" cellpadding="0" cellspacing="0" style="background:#1e3558;">
  <tr>
    ...
    <td style="padding:16px 12px; vertical-align:middle;">
      <p style="font-size:17px; font-weight:bold; color:#ffffff; letter-spacing:0.03em; margin-bottom:3px;">GASQ Mobile Patrol Report</p>
      <p style="font-size:9px; color:rgba(255,255,255,0.65); text-transform:uppercase; letter-spacing:0.1em;">Vendor Cost Analysis &amp; Hourly Bill Rate</p>
    </td>
