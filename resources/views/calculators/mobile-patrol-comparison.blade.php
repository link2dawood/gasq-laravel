...
function fmtN(v, dec = 0){return new Intl.NumberFormat((window.GASQ_CURRENCY&&window.GASQ_CURRENCY.locale)||'en-US',{minimumFractionDigits:dec,maximumFractionDigits:dec}).format((v)*((window.GASQ_CURRENCY&&window.GASQ_CURRENCY.rate)||1));}
