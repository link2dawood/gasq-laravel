...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        Faq::insert([
            ...
            ['question' => 'How do I accept a bid?', 'answer' => 'When a vendor responds to your job offer you can review their bid and message them before making a decision from your job details page.', 'audience' => 'vendor', 'cta_label' => null, 'cta_url' => null, 'order' => 7, 'is_active' => true, 'created_at' => now(), 'updated_at' => now()],
            ['question' => 'Is my payment information secure?', 'answer' => 'Yes. We use industry-standard encryption and do not store full card numbers. Billing is handled by our secure payment provider.', 'audience' => 'all', 'cta_label' => null, 'cta_url' => null, 'order' => 8, 'is_active' => true, 'created_at' => now(), 'updated_at' => now()],
        ]);
    }
}
