...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        Faq::insert([
            // Shared intro.
            ['question' => 'What is GASQ?', 'answer' => 'Get A Security Quote (GASQ) connects buyers and vendors of security services with transparent, independent pricing and tools so you know your true Cost to Protect before you buy.', 'audience' => 'all', 'cta_label' => null, 'cta_url' => null, 'order' => 1, 'is_active' => true, 'created_at' => now(), 'updated_at' => now()],

            // Foundational buyer FAQs.
            ['question' => 'What makes GASQ different from a traditional bidding platform?', 'answer' => 'GASQ is a procurement technology platform, not a bid marketplace. Instead of encouraging vendors to undercut one another, GASQ helps buyers make informed purchasing decisions through standardized pricing analysis, procurement documentation, and a structured vendor selection process. Vendors compete on qualifications, experience, responsiveness, and scope—not by racing to the lowest price.', 'audience' => 'buyer', 'cta_label' => null, 'cta_url' => null, 'order' => 2, 'is_active' => true, 'created_at' => now(), 'updated_at' => now()],
            ['question' => 'How do I know the pricing is fair?', 'answer' => 'GASQ uses its Cost to Protect™ methodology to evaluate the total cost of delivering security services. Our appraisal process helps buyers understand whether pricing is financially realistic, operationally sustainable, and procurement-ready before a contract is awarded.', 'audience' => 'buyer', 'cta_label' => null, 'cta_url' => null, 'order' => 3, 'is_active' => true, 'created_at' => now(), 'updated_at' => now()],
            ['question' => 'Can vendors negotiate their price?', 'answer' => "No. Vendors may accept or decline the buyer's offer. They may negotiate the scope of work if adjustments are needed, but they cannot negotiate the agreed price. This creates a transparent procurement process and eliminates vendor-to-vendor price shopping.", 'audience' => 'buyer', 'cta_label' => null, 'cta_url' => null, 'order' => 4, 'is_active' => true, 'created_at' => now(), 'updated_at' => now()],
            ['question' => 'Why am I required to interview vendors before awarding a contract?', 'answer' => 'Pricing is only one part of a successful security program. GASQ requires buyers to interview qualified vendors so they can evaluate experience, staffing capabilities, communication, technology, and cultural fit before making a final award.', 'audience' => 'buyer', 'cta_label' => null, 'cta_url' => null, 'order' => 5, 'is_active' => true, 'created_at' => now(), 'updated_at' => now()],
            ['question' => 'What documentation do I receive?', 'answer' => "Depending on your package, buyers may receive:\n• A GASQ Cost to Protect™ Appraisal\n• Procurement documentation\n• Vendor qualification reports\n• Interview scorecards\n• Award recommendations\n• Procurement audit trail for internal approval", 'audience' => 'buyer', 'cta_label' => null, 'cta_url' => null, 'order' => 6, 'is_active' => true, 'created_at' => now(), 'updated_at' => now()],

            // Foundational vendor FAQs.
            ['question' => 'Will my price be shared with competing vendors?', 'answer' => 'No. GASQ does not permit vendor-to-vendor price shopping. Your pricing remains confidential throughout the procurement process. Buyers evaluate vendors based on qualifications and interviews before any final pricing decisions.', 'audience' => 'vendor', 'cta_label' => null, 'cta_url' => null, 'order' => 2, 'is_active' => true, 'created_at' => now(), 'updated_at' => now()],
            ['question' => 'How do I win work on GASQ?', 'answer' => "Success is based on more than price. Buyers evaluate:\n• Experience\n• Licensing\n• Insurance\n• Staffing capability\n• Operational readiness\n• Interview performance\n• Ability to meet the requested scope\nThe goal is to award the best-qualified vendor—not simply the cheapest.", 'audience' => 'vendor', 'cta_label' => null, 'cta_url' => null, 'order' => 3, 'is_active' => true, 'created_at' => now(), 'updated_at' => now()],
            ['question' => 'Can I negotiate after receiving an offer?', 'answer' => "You may:\n• Accept the offer\n• Decline the offer\n• Request changes to the scope of work\nHowever, you may not negotiate the agreed price. This protects pricing integrity for all parties.", 'audience' => 'vendor', 'cta_label' => null, 'cta_url' => null, 'order' => 4, 'is_active' => true, 'created_at' => now(), 'updated_at' => now()],
            ['question' => 'Why does GASQ verify pricing?', 'answer' => 'GASQ is designed to help ensure security pricing is financially realistic and sustainable. This reduces the likelihood of underpriced contracts, service failures, excessive turnover, and hidden costs that often occur when contracts are awarded solely on the lowest bid.', 'audience' => 'vendor', 'cta_label' => null, 'cta_url' => null, 'order' => 5, 'is_active' => true, 'created_at' => now(), 'updated_at' => now()],
            ['question' => 'Why should I use GASQ instead of responding to traditional RFPs?', 'answer' => 'Traditional procurement often rewards the lowest bidder, leading to price compression and unsustainable contracts. GASQ allows vendors to compete on value, operational capability, and service quality while protecting them from unnecessary vendor-to-vendor price shopping.', 'audience' => 'vendor', 'cta_label' => null, 'cta_url' => null, 'order' => 6, 'is_active' => true, 'created_at' => now(), 'updated_at' => now()],

            // Operational FAQs (follow the foundational block).
            ['question' => 'How do credits work?', 'answer' => 'Credits are used to run calculators and generate reports. You can buy credit packages any time from the Credits page, and your balance is shown in the top navigation.', 'audience' => 'all', 'cta_label' => 'View Credits', 'cta_url' => '/credits', 'order' => 20, 'is_active' => true, 'created_at' => now(), 'updated_at' => now()],
            ['question' => 'Can I get a refund?', 'answer' => 'No. Credit purchases are final and non-refundable. Your credits never expire, so any you do not use stay in your account for future calculators and reports. If you believe you were charged in error, contact support and we will make it right.', 'audience' => 'all', 'cta_label' => null, 'cta_url' => null, 'order' => 21, 'is_active' => true, 'created_at' => now(), 'updated_at' => now()],
            ['question' => 'What calculators are available?', 'answer' => 'As a buyer you have the Instant Estimator and the Know Before You Buy Calculator. Vendors get the full calculator suite (Workforce Calculator, Mobile Patrol, Mobile Patrol Hit, Main Menu Calculator and more). Each run uses credits.', 'audience' => 'all', 'cta_label' => 'Open the Instant Estimator', 'cta_url' => '/instant-estimator', 'order' => 22, 'is_active' => true, 'created_at' => now(), 'updated_at' => now()],
            ['question' => 'Is my payment information secure?', 'answer' => 'Yes. We use industry-standard encryption and do not store full card numbers. Billing is handled by our secure payment provider.', 'audience' => 'all', 'cta_label' => null, 'cta_url' => null, 'order' => 23, 'is_active' => true, 'created_at' => now(), 'updated_at' => now()],
            ['question' => 'How do I post a job?', 'answer' => 'From your dashboard choose Post a Job, tell us the security service and job site, then complete the buyer questionnaire. GASQ qualifies the request and releases it to matched vendors.', 'audience' => 'buyer', 'cta_label' => 'Post a Job', 'cta_url' => '/jobs/create', 'order' => 24, 'is_active' => true, 'created_at' => now(), 'updated_at' => now()],
            ['question' => 'How do I become a vendor?', 'answer' => 'Create an account and choose Vendor, then complete your company profile to appear on the marketplace and respond to job offers.', 'audience' => 'vendor', 'cta_label' => 'Create a Vendor Account', 'cta_url' => '/register', 'order' => 25, 'is_active' => true, 'created_at' => now(), 'updated_at' => now()],
            ['question' => 'How do I accept a bid?', 'answer' => 'When a vendor responds to your job offer you can review their bid and message them before making a decision from your job details page.', 'audience' => 'vendor', 'cta_label' => null, 'cta_url' => null, 'order' => 26, 'is_active' => true, 'created_at' => now(), 'updated_at' => now()],
        ]);
    }
}
