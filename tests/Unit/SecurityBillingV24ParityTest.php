...
class SecurityBillingV24ParityTest extends TestCase
{
    #[DataProvider('cases')]
    public function test_security_billing_v24_cases_match_expected(string $caseFile): void
    {
        ...
        /** @var SecurityBillingV24ComputeService $svc */
        $svc = $this->app->make(SecurityBillingV24ComputeService::class);
    ...
    {
        $base = base_path('tests/Fixtures/v24/security_billing');
        return [
